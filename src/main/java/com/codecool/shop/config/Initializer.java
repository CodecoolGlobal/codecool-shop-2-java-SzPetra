...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("be the Sound of Balaton", new BigDecimal("500.000"), Currency.HUF, "If you've always loved music, this is the perfect opportunity for you. Now you can be the Sound of Balaton. Living in a mansion by the hungarian sea. As a very famous producer, you have studios in the basement and a pool in the garden. Living your best life.", inland, petraCompany));
